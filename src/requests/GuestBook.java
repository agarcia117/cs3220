...
public class GuestBook extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		ArrayList<AlbumEntry> guestbookEntries = new ArrayList<AlbumEntry>();
		
		// Pre-populate my guest book with some entries
		guestbookEntries.add( new AlbumEntry("John Doe", "Hello, World!"));
		guestbookEntries.add( new AlbumEntry("Mary Jane", "Hi!"));
		guestbookEntries.add( new AlbumEntry("Joe Boxer", "Howdy!"));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("searchBtn") != null) {
			...
			if (searchType.equals("ID")) {
				...
				ArrayList<AlbumEntry> searchResults = new ArrayList<AlbumEntry>();
